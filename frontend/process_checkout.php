...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Retrieve form data that was submitted
    ...
    if (mysqli_query($conn, $query)) {
        // If the Customer information is inserted successfully, redirects to payment page
    ...
    // If the form is not submitted, redirects the user to the checkout page
